  ...
  return (
    <section className="py-16 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      <div className="container mx-auto px-6 sm:px-10">
        ...
        <motion.p
          className="mt-6 text-lg text-center text-gray-300 sm:text-xl"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          transition={{ duration: 1, delay: 0.2 }}
        >
          ...
          <span className="font-bold text-green-400">phantom-request</span> via
          npm or yarn:
        </motion.p>
        <motion.div
          className="mt-10 bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 1, delay: 0.4 }}
        >
          <div className="font-mono">NPM:</div>
          <pre className="text-lg font-mono bg-gray-900  text-gray-100 p-4 rounded-lg">
            <code className="block">
              <span className="text-green-400">$</span> npm install
              phantom-request
            </code>
          </pre>
          <div className="font-mono">Yarn:</div>
          <pre className="text-lg font-mono bg-gray-900  text-gray-100 p-4 rounded-lg">
            <code className="block">
              <span className="text-green-400">$</span> yarn add phantom-request
            </code>
          </pre>
        </motion.div>
        <motion.div
        ...
        >
          <a
            href="/docs/intro"
            className="inline-block px-6 py-3 hover:no-underline text-lg font-medium text-black bg-green-400 rounded-lg shadow-md hover:bg-green-500"
          >
            View Documentation 📚
          </a>
        </motion.div>
